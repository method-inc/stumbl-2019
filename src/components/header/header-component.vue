...
<template>
  <header>
    <nav class="header--nav">
      ...
      <router-link class="header--nav-rewards-icon"  v-if="!['about', 'rewards', 'venue'].includes($route.name)" to="/rewards">
        <img src="../../images/rewards_icon.svg" alt="Points icon">
      </router-link>
      <router-link v-if="!['about', 'rewards', 'venue'].includes($route.name)" to="/about">
        <img src="../../images/info_icon.svg" alt="Info icon">
      </router-link>
      <router-link v-if="['about', 'rewards', 'venue'].includes($route.name)" to="/">
